                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h3 class="text-center">Você tem certeza que deseja excluir o admin <strong><?php echo $usuario->getNome(); ?></strong>?</h3>
                                </div>
                            </div>
                            ...
                            <?php echo form_open('painel_controller/user_delete_post', array('id' => 'form_hidden_to_submit'), array('id' => $usuario->getId())); ?>
                            <?php echo form_close(); ?>
                            <!-- /.row (nested) -->
                        </div>
                        <!-- /.panel-body -->
